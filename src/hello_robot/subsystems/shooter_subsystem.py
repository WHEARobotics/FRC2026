...
class ShooterSubsystem(commands2.subsystem):
    def __init__(self):
        ...
        self.shooter_motor = rev.SparkFlex(ShooterConstants.MOTOR, rev.SparkFlex.MotorType.kBrushless)
        self.kicker_motor = rev.SparkMax(ShooterConstants.KICKER, rev.SparkMax.MotorType.kBrushless)
