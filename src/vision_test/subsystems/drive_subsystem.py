...
class DriveSubsystem(commands2.Subsystem):
    ...
    def add_vision_measurement(self, pose: Pose2d, timestamp: float, std_devs: Tuple[float, float, float]):
        self.odometry.addVisionMeasurement(pose, timestamp, std_devs)